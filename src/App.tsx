...
import MentorApplicationPage from './components/Dashboard/scenes/ManageMentorApplications/MentorApplicationPage.tsx';
      ...
      <BrowserRouter>
        <MainLayout>
          <Routes>
            ...
            <Route
              path="/dashboard/mentor-application/:mentorUuid"
