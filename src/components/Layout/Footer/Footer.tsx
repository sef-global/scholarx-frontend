      ...
      <div className="flex flex-col">
        ...
        <div className="flex flex-row gap-2 mt-2">
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-twitter-icon.svg" alt="twitter-icon" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-fb-icon.svg" alt="facebook-icon" />
          </a>
          <a
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-insta-icon.svg" alt="instagram-icon" />
          </a>
          <a
          ...
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-yt-icon.svg" alt="youtube-icon" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-slack-icon.svg" alt="slack-icon" />
          </a>
          <a
            ...
            rel="noreferrer"
          >
            <img src="/footer-discourse-icon.svg" alt="discourse-icon" />
          </a>
        </div>
      </div>
