...
const MenteeCard: React.FC<MenteeCardProps> = ({
  ...
  return (
    ...
    >
      ...
      <div className="text-left p-px">
        <h5 className="text-lg font-bold">
          {mentee.application.firstName} {mentee.application.lastName}
        </h5>
        {mentee.application.isUndergrad ? (
          <p className="text-xs text-gray-500 flex items-center">
            <svg className="w-4 h-4 text-gray-500 dark:text-white mr-2" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 20">
